        ...
        <div className='flex flex-col  items-center px-3 py-5 space-y-4 '>
            ...
            <div className='flex space-x-2 py-2 mt-3'>
                <small className='h-10 w-10 rounded-full bg-slate-200 flex items-center justify-center'>
                    <Image src="images/tiktok.svg" alt='tiktok' width={30} height={30} className='rounded-full' />
                </small>
                <small className='h-10 w-10 rounded-full bg-slate-200 flex items-center justify-center'>
                    <Image src="images/facebk.svg" alt='facebook' width={30} height={30} className='rounded-full' />
                </small>
            </div>
